...
<div class="form-group row">
  <label class="col-md-2 col-form-label">Keterangan Berita</label>
    <div class="col-md-10">
...
<div class="form-group row">
  <label class="col-md-2 col-form-label">Keyword(Untuk SEO Google)</label>
    <div class="col-md-10">
      <textarea name="keyword" class="form-control" placeholder="Keyword" ><?php echo $berita->keyword ?></textarea>
    </div>
</div>
<div class="form-group row">
