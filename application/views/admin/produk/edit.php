...
<div class="form-group row">
  <label class="col-md-2 col-form-label">Kode Produk</label>
    <div class="col-md-5">
      <input type="text" name="kd_produk" class="form-control" placeholder="Kode Produk" value="<?php echo $produk->kd_produk ?>" required>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
  <label class="col-md-2 col-form-label">Keyword(Untuk SEO Google)</label>
    <div class="col-md-10">
      <textarea name="keyword" class="form-control" placeholder="Keyword" ><?php echo $produk->keyword ?></textarea>
    </div>
</div>
<div class="form-group row">
