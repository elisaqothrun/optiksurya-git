...
<div class="w-size14 p-t-30 respon5">
	<h1 class="product-detail-name m-text20 p-b-10">
    ...
    // echo form_hidden('qty', $produk->jumlah);
    // elemen redirect
            ...
            <!-- Block2 -->
                    <div class="block2">
                        <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                            <img src="<?php echo base_url('assets/upload/images/thumbs/'.$produk_related->gambar)?>" alt="<?php echo $produk_related->nama_produk ?>">
